...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1719440888);
user_pref("app.update.lastUpdateTime.background-update-timer", 1719440888);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1719440888);
user_pref("app.update.lastUpdateTime.region-update-timer", 1719095281);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1719440888);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1718663301);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1719440888);
...
user_pref("browser.startup.lastColdStartupCheck", 1719440858);
...
user_pref("media.gmp-manager.lastCheck", 1719440883);
user_pref("media.gmp-manager.lastEmptyCheck", 1719440883);
...
user_pref("toolkit.startup.last_success", 1719440857);
